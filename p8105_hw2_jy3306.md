...
``` r
anti_join(bakeoff_combined_df, viewers_df, by = "series")
```
...
#### Viewers dataset cleaning process

The `Viewers` data was imported and missing data was labled as “na”.
Using the pivot_longer function and removing the prefix of “series\_”, I
made a common variable of “series” that is present in all datasets.

#### Description of the dataset

The bakeoff_combined_df dataset combines `bakers`, `bakes`, `results`,
and `viewers` datasets by the common variables of name_series that was
...
and episode. This dataset contains **540** rows and **12** columns.
